...
https://github.com/Antonidas21/Trabajo_final_R.git
# 1. Introducción
...
colores_narojo <- colorRampPalette(brewer.pal(9,"Oranges"))

hw4 = wordcloud2(bloques_count_periodico[,2:3], color = rev(colores_narojo(nrow(bloques_count_periodico))))
...
colores_verzul <- colorRampPalette(brewer.pal(9,"Greens"))

hw3 = wordcloud2(bloques_count_okdiario[,2:3], color = rev(colores_verzul(nrow(bloques_count_okdiario))))
